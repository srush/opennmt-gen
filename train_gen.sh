...
python train.py -data $BASE/fixed -save_model /tmp/model_name -layers 2 -rnn_size 600  -feat_vec_size 600 -word_vec_size 600 -batch_size 5  -epochs 20  -report_every 100 -gpuid 1  -encoder_type mean -copy_attn -dropout 0.3 -global_attention dot -truncated_decoder 100 -copy_attn_force 
